...
export default function App() {
  ...
  const OG_IMG  = `${ORIGIN}/og-banner.jpg`;
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        {/* Canonical всегда на RU */}
        <link rel="canonical" href={URL_RU} />
        ...
        <meta property="og:url" content={lang === "uz" ? URL_UZ : URL_RU} />
        ...
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "FAQPage",
          "mainEntity": i18n[lang].faq.map(([q,a]) => ({
            "@type": "Question",
            "name": q,
          ...
          "@graph": [
            {
              ...
              "provider": { "@type":"Organization","name":"UTL School","url": URL_RU },
              "hasCourseInstance": [{
                "@type": "CourseInstance",
                "courseMode": "online, offline",
                "inLanguage": lang,
                "location": { "@type":"Place","name":"Tashkent" },
                "offers": { "@type":"Offer","priceCurrency":"UZS","availability":"https://schema.org/InStock" }
              }]
            },
            {
              "@type": "Course",
              "name": lang==="uz" ? "Chuqur o‘rganish" : "Погружение",
              "description": lang==="uz" ? "5 hafta, 11 dars + yordam" : "5 нед, 11 занятий + поддержка",
              "provider": { "@type":"Organization","name":"UTL School","url": URL_RU }
            },
            {
              "@type": "Course",
              "name": "Премиум",
              "description": lang==="uz" ? "12 dars + karyera" : "12 занятий + карьера",
              "provider": { "@type":"Organization","name":"UTL School","url": URL_RU }
            }
          ]
        })}</script>
          ...
          <div className="pricing">
            ...
            <article className="plan">
              ...
              <ul className="features">
                ...
                <li>{lang === "уз" ? "Uy vazifalari tekshiruvi + fikr-mulohaza" : "Домашки с проверкой + обратная связь"}</li>
              </ul>
