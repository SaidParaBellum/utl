...
const benefitsData = [
  { t: "Заработок", d: "Заработок во время обучения", icon: "money" },
  { t: "Стажировка", d: "Гарантированная стажировка в логистической компании", icon: "briefcase" },
  { t: "Практика", d: "Учебная практика на реальных заказах", icon: "clipboard" },
  { t: "Сертификат", d: "Сертификат после обучения", icon: "award" },
          ...
          <div className="container hero__inner">
            <div className="hero__content">
              ...
              <p className="p" style={{ maxWidth: 680 }}>
                Онлайн и офлайн обучение. <br /> Реальные кейсы, практика, сертификат и помощь в трудоустройстве.
              </p>
            ...
            <div className="hero__image">
              <img src="/src/assets/notebook.png" alt="UTL School" />
            </div>
          </div>
        </header>
...
<section id="courses" className="section section--soft withRouteBG">
  {/* можешь оставить линию маршрута либо убрать — на вкус */}
  ...
  <div className="container routeContent">
    ...
    <div className="pricing">
      ...
      <article className="plan plan--featured">
        ...
        <div className="plan__foot">
          <a className="cta cta--mega" href="#contact" style={{ textDecoration: "none" }}>
      ...
      <article className="plan">
        ...
        <div className="plan__foot">
          ...
          <div className="note">Лимит мест · Индивидуальная поддержка</div>
        </div>
      </article>
    </div>

    {/* доверие / social proof под тарифами (по желанию) */}
    {/* SOCIAL PROOF */}
<div className="proof">
  <div className="proof__row">
    ...
    <div className="proof__card">
      <div className="stars" aria-label="Рейтинг 4.9 из 5">
        <svg viewBox="0 0 24 24" className="star"><path d="M12 2l2.9 6.7 7.1.6-5.3 4.6 1.7 6.9L12 17.7 5.6 20.8l1.7-6.9L2 9.3l7.1-.6L12 2z"/></svg>
        <svg viewBox="0 0 24 24" className="star"><path d="M12 2l2.9 6.7 7.1.6-5.3 4.6 1.7 6.9L12 17.7 5.6 20.8l1.7-6.9L2 9.3l7.1-.6L12 2z"/></svg>
        <svg viewBox="0 0 24 24" className="star"><path d="M12 2l2.9 6.7 7.1.6-5.3 4.6 1.7 6.9L12 17.7 5.6 20.8l1.7-6.9L2 9.3l7.1-.6L12 2z"/></svg>
        <svg viewBox="0 0 24 24" className="star"><path d="M12 2l2.9 6.7 7.1.6-5.3 4.6 1.7 6.9L12 17.7 5.6 20.8l1.7-6.9L2 9.3l7.1-.6L12 2z"/></svg>
        <svg viewBox="0 0 24 24" className="star"><path d="M12 2l2.9 6.7 7.1.6-5.3 4.6 1.7 6.9L12 17.7 5.6 20.8l1.7-6.9L2 9.3l7.1-.6L12 2z"/></svg>
      </div>
      <div className="proof__label">
        4.9/5 по отзывам студентов
      </div>
    </div>
    ...
    <div className="proof__card">
      <div className="avatars">
        <img src="/src/assets/ava1.jpg" alt="" />
        <img src="/src/assets/ava2.jpg" alt="" />
        <img src="/src/assets/ava3.jpg" alt="" />
        <img src="/src/assets/ava4.jpg" alt="" />
        <span className="avatars__more">+2k</span>
      </div>
      <div className="proof__label">
        Выпускники уже в логистических компаниях
      </div>
    </div>
  ...
  {/* Логотипы партнёров/где работают */}
  <div className="proof__logos" aria-label="Партнёры и работодатели">
    <img src="/src/assets/brand1.svg" alt="Партнёр 1" />
    <img src="/src/assets/brand2.svg" alt="Партнёр 2" />
    <img src="/src/assets/brand3.svg" alt="Партнёр 3" />
    <img src="/src/assets/brand4.svg" alt="Партнёр 4" />
    <img src="/src/assets/brand5.svg" alt="Партнёр 5" />
  </div>
</div>
...
<div className={`fadeScene ${howIdx === 2 ? "active" : ""}`}>
  <div className="scene">
    ...
    {/* единый блок (без вложенной карточки внутри карточки) */}
    <div className="logiCard">
      <svg className="logiSVG" viewBox="0 0 320 450" preserveAspectRatio="xMidYMid meet">
        <defs>
          <linearGradient id="lgMint" x1="0" y1="0" x2="1" y2="0">
          ...
          {/* маршрут */}
          <path id="routePath"
                d="M 28 360 L 90 300 L 128 318 L 172 270 L 208 235 L 238 232 L 268 190 L 294 150"
                fill="none" />
        ...
        {/* фон карточки */}
        <rect width="320" height="450" rx="18" fill="#ffffff"/>
        <rect width="320" height="450" rx="18"
              fill="url(#lgBG)" opacity="0">
          <animate attributeName="opacity" from="0" to="0" dur="0.1s" fill="freeze"/>
        </rect>

        {/* линия маршрута (сплошная + бегущий штрих) */}
        <use href="#routePath" stroke="url(#lgMint)" strokeWidth="10" fill="none" strokeLinecap="round"/>
        <use href="#routePath" stroke="#7bbdb6" strokeWidth="10" fill="none" strokeDasharray="16 12">
          <animate attributeName="stroke-dashoffset" from="0" to="-180" dur="1.8s" repeatCount="indefinite"/>
        </use>
        ...
        {[
          { x:90,  y:300, t:"Start"  },
          { x:208, y:235, t:"UTL"    },
          { x:294, y:150, t:"Client" },
        ].map((c,i)=>(
          <g key={i} transform={`translate(${c.x},${c.y})`}>
            <circle r="7" fill="#7BBDB6"/>
            <circle r="12" fill="none" stroke="#7BBDB6" strokeOpacity=".55">
              <animate attributeName="r" values="12;16;12" dur="1.8s" repeatCount="indefinite" begin={`${i*0.25}s`}/>
              <animate attributeName="stroke-opacity" values=".55;0;.55" dur="1.8s" repeatCount="indefinite" begin={`${i*0.25}s`}/>
            </circle>
            <text x="10" y="-10" fontFamily="Inter,system-ui" fontSize="12" fill="#3a6763">{c.t}</text>
            {/* «коробки» */}
            {[0,1,2].slice(0, i ? 3 : 2).map(k=>(
              <rect key={k} x={-18 + k*9} y="-26" width="8" height="8" rx="2" fill="#7bbdb6" opacity=".9">
                <animate attributeName="y" values="-26;-34;-26" dur=".9s" begin={`${0.6 + i*0.3}s`} repeatCount="indefinite"/>
              </rect>
            ))}
          </g>
        ))}

        {/* грузовик едет по пути */}
        <g filter="url(#softShadow)">
          <g id="truck">
            <rect x="-20" y="-12" width="40" height="24" rx="4" fill="#0f1418"/>
            <rect x="-40" y="-14" width="22" height="28" rx="4" fill="#22292f"/>
            <rect x="-32" y="-6" width="12" height="14" rx="2.5" fill="#cfe9e5"/>
            <circle cx="-26" cy="14" r="4.2" fill="#0f1418"/>
            <circle cx="14"  cy="14" r="4.2" fill="#0f1418"/>
          </g>
          <animateMotion xlinkHref="#truck" dur="4.8s" repeatCount="indefinite" rotate="auto">
    ...
    {/* компактная подпись/метрики, чтобы «не пусто» вокруг */}
    <div className="logiMeta">
      <span className="chip">🚚 12 заказов</span>
      <span className="chip">⏱ ETA 2д</span>
      <span className="chip">🧭 Маршрут UTL</span>
    </div>
  </div>
</div>
                ...
                <div className="scene">
                  <div className="dual">
                    ...
                    <div style={{ display: "grid", placeItems: "center", gap: 12 }}>
                      ...
                      <div className="pulse" style={{ width: "60%" }} />
                      <div className="pulse" style={{ width: "40%" }} />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div className="footer__right">
      <div className="footer__contacts">
        ...
        <div className="footer__links">
          ...
          <a href="https://instagram.com/utl_school" target="_blank" rel="noopener noreferrer" className="footer__icon ig" aria-label="Instagram">
